...
|------|------|---------------------|
| [[11_JVM_Internals]] | JVM и устройство Java | bytecode, Stack/Heap, GC |
| [[01_Basics]] | Синтаксис и основы | типы, операторы, строки, циклы |
| [[02_OOP_Core]] | ООП: классы и объекты | class, object, constructor |
...
| [[08_Functional]] | Функциональный стиль | lambda, Stream, Optional |
| [[09_Multithreading]] | Многопоточность | Thread, synchronized, volatile |
| [[10_SOLID]] | SOLID | SRP, OCP, DIP |
| [[12_Design_Patterns]] | Паттерны GoF | Factory, Strategy, Observer |
